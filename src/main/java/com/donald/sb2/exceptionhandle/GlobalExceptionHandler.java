...
public class GlobalExceptionHandler {
    ...
    private String constraintViolationException(ConstraintViolationException ex){
        Set x = ex.getConstraintViolations();
        for(Object s:x){
            ConstraintViolation s1 = (ConstraintViolation)s;
            System.out.println(s1.getRootBean().getClass().getPackage());
            System.out.println(s1.getRootBean().getClass().getName());
            System.out.println(s1.getPropertyPath());
            System.out.println(s1.getConstraintDescriptor().getAnnotation().annotationType().getName());
            System.out.println(s1.getLeafBean().getClass().getName());
            System.out.println(s1.getPropertyPath());
            String[] test = s1.getPropertyPath().toString().split("\\.");
            System.out.println(test[test.length-1]);
            System.out.println(s1.getMessage());
            System.out.println(s1.getConstraintDescriptor());
            System.out.println(s1.getMessageTemplate());
        }
        return "dsf";
    }
}
